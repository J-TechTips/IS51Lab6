...
based on the restult of the random number, we check to see if it falls under certain range
...
we iterate over using a loop three trimes and print the results to the user.

"""

"""
import  random
num = generate radom number
